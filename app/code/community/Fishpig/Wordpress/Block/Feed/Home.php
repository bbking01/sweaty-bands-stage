...
class Fishpig_Wordpress_Block_Feed_Home extends Fishpig_Wordpress_Block_Feed_Abstract
{
	...
	public function getPosts()
	{
		$collection = Mage::getResourceModel('wordpress/post_collection')
			...
			->setOrderByPostDate()
			->setPageSize(Mage::helper('wordpress')->getWpOption('posts_per_rss', 10));

		Mage::dispatchEvent('wordpress_block_feed_home_post_collection_before_load', array('block' => $this, 'collection' => $collection));
