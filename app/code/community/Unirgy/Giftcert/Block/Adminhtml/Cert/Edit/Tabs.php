    ...
    protected function _beforeToHtml()
    {
        ...
        if (Mage::getStoreConfig('ugiftcert/default/use_conditions')){
            $this->addTab('conditions', array(
                'label'     => Mage::helper('ugiftcert')->__('Gift Certificate Conditions'),
                'title'     => Mage::helper('ugiftcert')->__('Gift Certificate Conditions'),
                'content'   => $this->getLayout()->createBlock('ugiftcert/adminhtml_cert_edit_tab_conditions')->toHtml(),
            ));
        }
