 ...
 * 
 * 
 *  original: public function getProductPrice($product) 
 * 
 * =========================================================================================================================*/
    public function getProductPrice($product)
    {
 //Mage::log(__FILE__.'  '.__LINE__." getProductPrice: "); 	
 	
/*
 * DCS: REMOVED we do this elsewhere
...
*/
 ...
 //Mage::log(__LINE__." getProductPrice: "); 
        ...
        if(1) {
        //if (Mage::helper('customergroupsprice')->isGroupActive($groupId)) { //DCS: REMOVED we do this elsewhere
