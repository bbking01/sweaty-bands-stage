...
class Webtex_CustomerGroupsPrice_Block_Adminhtml_System_Convert_Import extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        return Mage::helper('adminhtml')->__('Customer Groups Price Import');
    }
}
