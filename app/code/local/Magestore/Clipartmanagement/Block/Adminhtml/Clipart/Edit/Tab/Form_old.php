...
{ 
  protected function _prepareForm()
  {
	 ...
	 foreach($parent_category as $parent)	 
	 {	 		 
	 	$category[$parent['label'].'_'.$parent['value']][] = Mage::getModel('clipartmanagement/clipartcategory')->getCollection()->addFieldToFilter('parent_cat_id', $parent['value'])->toOptionArray();				
	 }
