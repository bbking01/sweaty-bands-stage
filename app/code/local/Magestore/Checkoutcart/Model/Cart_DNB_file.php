 ...
 */
class Magestore_Checkoutcart_Model_Cart extends Mage_Checkout_Model_Cart
{
     ...
     */
    public function addOrderItem($orderItem, $qtyFlag=null, $orderItem)
    {
        ...
        if (is_null($orderItem->getParentItem())) {
            ...
            $this->addProduct($product, $info, $orderItem);
        }
        return $this;
    }
     ...
     * @return  Mage_Checkout_Model_Cart
     */
    public function addProduct($product, $info=null, $orderItem=null)
    {
        ...
        if ($product->getId()) {
            $result = $this->getQuote()->addProduct($product, $request, $orderItem);
            /**
