<?php
class Magestore_Gallery_Block_Admin_Gallery_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
     ...
     $this->addColumn('filename', array(
	  ...
	  $this->addColumn('album_id', array(
          'header'    => Mage::helper('gallery')->__('Ideas Category'),
          'align'     =>'left',
		  'width'     => '100px',
          'index'     => 'album_id',
		  'type'      => 'options',
