...
class AW_Popup_Block_Adminhtml_Popup_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('show_count', 'text', array(
            'label' => Mage::helper('popup')->__('General number of shows'),
            'required' => true,
            'name' => 'show_count',
            'note' => $this->__('0 - unlimit usage'),
        ));

        $fieldset->addField('show_count_per_customer', 'text', array(
        ...
        $fieldset->addField('use_count', 'label', array(
            'label' => Mage::helper('popup')->__('Used show count'),
            'required' => false,
            'name' => 'use_count',
        ));
        ...
        $fieldset->addField('height', 'text', array(
            ...
            'required' => false,
            'name' => 'height',
            'note' => $this->__('Miimum value is 300'),
        ));
        ...
        if (Mage::getSingleton('adminhtml/session')->getPopupData() == NULL && Mage::registry('popup_data')->getData() == NULL)
