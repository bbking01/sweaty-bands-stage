 ...
 */
class MW_RewardPoints_Block_Adminhtml_Catalogrules_Edit_Tab_Actions extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
	   ...
	   $fieldset->addField('simple_action', 'select', array(
          ...
          'name'      => 'simple_action',
		  'options'   => MW_RewardPoints_Model_Typerule::getOptionArray()
      	));
