...
class MW_RewardPoints_Block_Adminhtml_Catalogrules_Edit_Tab_Conditions extends Mage_Adminhtml_Block_Widget_Form
{
    /**
...
//    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('conditions_fieldset', array(
            'legend'=>Mage::helper('rewardpoints')->__('Conditions (leave blank for all products)')
