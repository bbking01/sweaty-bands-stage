<?php
class MW_Rewardpoints_Block_Adminhtml_Products_Edit_Tab_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        */
        ...
        $this->addColumn('reward_point_product',
            array(
                'header'=> Mage::helper('rewardpoints')->__('Reward Points Earned'),
                'width' => '100px',
                'type'  => 'number',
