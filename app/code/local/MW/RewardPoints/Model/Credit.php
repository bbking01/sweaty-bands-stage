...
class MW_RewardPoints_Model_Credit extends Varien_Object
{
	...
	public function exchange($argv)
	{
		...
		try{
			...
			$historyData = array('type_of_transaction'=>MW_RewardPoints_Model_Type::EXCHANGE_FROM_CREDIT, 'amount'=>$rewardPoints, 'balance'=>$_customer->getMwRewardPoint(),'transaction_detail'=>'', 'transaction_time'=>now(), 'status'=>MW_RewardPoints_Model_Status::COMPLETE);
